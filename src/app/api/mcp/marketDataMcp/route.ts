...
export async function GET(req: Request) {
    try {
        // Discovery endpoint
        const response = await fetch(`${FIREBASE_FUNCTIONS_BASE}/marketDataMcp`, {
            method: 'GET',
        });
        ...
        console.error('Error in marketDataMcp discovery:', error);
...
export async function POST(req: Request) {
    try {
        ...
        console.error('Error in marketDataMcp tool call:', error);
        return NextResponse.json(
